...
namespace SAP.Admin
{
    public class MembershipUserCustomize : MembershipUser
    {
        private decimal rate_hour;
        private string db_name;
        private string user_type;

        public decimal Rate_Hour
        {
            get { return rate_hour; }
            set { rate_hour = value; }
        }
        ...
        public MembershipUserCustomize(string providername,
                                  string username,
