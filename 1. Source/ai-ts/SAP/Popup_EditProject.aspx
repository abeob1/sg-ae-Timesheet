<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Popup_EditProject.aspx.cs" Inherits="SAP.Popup_EditProject" %>
			...
			<asp:ListView ID="listWareHouses" runat="server">
				...
				<ItemTemplate>
					<tr>
						...
						<td style="display:none">
							<asp:Label runat="server" ID="lblSrvType"><%#Eval("SrvType") %></asp:Label>
						</td>
						<td style="display:none">
							<asp:Label runat="server" ID="lblTimeEndDate"><%#Eval("TimeEndDate")%></asp:Label>
						</td>
					</tr>
				</ItemTemplate>
				<EmptyDataTemplate>
