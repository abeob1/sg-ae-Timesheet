...
namespace SAP
{
    public partial class ProjectMandaysUsedByPhaseReport : System.Web.UI.Page
    {
        ...
        protected void Binding()
        {
            ...
            ds = SqlHelper.ExecuteDataSet(Data.ConnectionString, CommandType.StoredProcedure, "sp_ProjectMandaysUsedByPhaseReport",
        ...
        private void SetForm()
        {
            for(int i = 0; i < lvStage.Items.Count ; i++)
            {
                ...
                if (ds.Tables[0].Rows[i]["Total"].ToString().Equals("True"))
                {
                    ...
                    ((Label)lvi.FindControl("Phase")).Font.Bold =
        ...
        private void ExportToExcelWithFormat()
        {
            ...
            dg.DataBind();
            FillDataToExcel("ProjectMandaysUsedByPhaseReport.xls", dg);
            dg = null;
            dg.Dispose();
        }
        #endregion
        ...
        {   //Create Tempory Table
            ...
            mdtExport2Xls.Columns.Add("<b>Phase</b>");
            ...
            foreach (ListViewDataItem lvi in lvStage.Items)
            {
                ...
                if (((Label)lvi.FindControl("lblTotal")).Text.Equals("False"))
                {
                    ...
                    drAddItem[2] = ((Label)lvi.FindControl("Phase")).Text;           // Consultant
                ...
                else
                {
                    ...
                    drAddItem[2] = "<b>" + ((Label)lvi.FindControl("Phase")).Text + "</b>";// Consultant
