<%@ Page Title="Sub-contractor Expense Entry" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="SubcontractorExpenseEntry.aspx.cs" Inherits="SAP.SubcontractorExpenseEntry" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
        ...
        function Populate(eventType) {
            switch (eventType) {
                case "add":
                    Main.openCustomDialog('../Popup_UserList.aspx?id=1&no=0', 600, 610); return false;
                    break;
        ...
        <ContentTemplate>
            <div id="contentData" style="padding-left: 15px;">
                <div id="title-form" style="border-bottom: 2px solid black;">
                    <h2 style="font-size: small">Sub-contractor Expense Entry</h2>
                </div>
                <div id="header-form">
                    ...
                    <asp:ListView ID="lvStage" runat="server" OnItemInserted="lvStage_ItemInserted"
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td style="text-align: center">
                                    <asp:Label ID="lblUserCode" runat="server"><%#Eval("UserCode")%></asp:Label>
                                </td>
                                <td style="text-align: left">
                        ...
                        <EditItemTemplate>
                            <tr>
                                ...
                                <td >
                                    <asp:HyperLink ID="linkEmployee" ToolTip="Select Employee" NavigateUrl='<%# String.Format("javascript:Main.openCustomDialog(\"../Popup_UserList.aspx?id=1&no={0},600,610)",  Eval("No").ToString() + "\"")%>'
                                                runat="server">
                                        <asp:Image ID="imgEmp" runat="server" ImageUrl="~/skin/images/item-pointer.gif" />
                                    </asp:HyperLink>
                                    <asp:Label runat="server" ID="lblEmpCodeEdit"  Text='<%# Bind("UserCode") %>'></asp:Label>
                                </td>
                                <td >
                                    <asp:HyperLink ID="linkItems" ToolTip="Select Project" NavigateUrl='<%# String.Format("javascript:Main.openCustomDialog(\"../Popup_EditProject.aspx?id={0},600,610)",  Eval("No").ToString() + "\"")%>'
                                                runat="server">
