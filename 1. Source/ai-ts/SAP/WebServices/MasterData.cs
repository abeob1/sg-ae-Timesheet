...
public partial class MasterData : System.Web.Services.Protocols.SoapHttpClientProtocol {
    ...
    private System.Threading.SendOrPostCallback GetCustomGroupOperationCompleted;
    
    private System.Threading.SendOrPostCallback GetOrderIntervalOperationCompleted;
    ...
    public MasterData() {
        ...
        if (String.IsNullOrEmpty(urlSetting))
            this.Url = "http://localhost:33885/MasterData.asmx";
        else
            this.Url = urlSetting;
    }
    ...
    /// <remarks/>
    public event GetCustomGroupCompletedEventHandler GetCustomGroupCompleted;
    
    /// <remarks/>
    public event GetOrderIntervalCompletedEventHandler GetOrderIntervalCompleted;
    ...
    /// <remarks/>
    [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://electra-ai.com/GetCustomGroup", RequestNamespace="http://electra-ai.com/", ResponseNamespace="http://electra-ai.com/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
    public System.Data.DataSet GetCustomGroup(string UserID) {
        object[] results = this.Invoke("GetCustomGroup", new object[] {
                    UserID});
        return ((System.Data.DataSet)(results[0]));
    }
    
    /// <remarks/>
    public System.IAsyncResult BeginGetCustomGroup(string UserID, System.AsyncCallback callback, object asyncState) {
        return this.BeginInvoke("GetCustomGroup", new object[] {
                    UserID}, callback, asyncState);
    }
    
    /// <remarks/>
    public System.Data.DataSet EndGetCustomGroup(System.IAsyncResult asyncResult) {
        object[] results = this.EndInvoke(asyncResult);
        return ((System.Data.DataSet)(results[0]));
    }
    
    /// <remarks/>
    public void GetCustomGroupAsync(string UserID) {
        this.GetCustomGroupAsync(UserID, null);
    }
    
    /// <remarks/>
    public void GetCustomGroupAsync(string UserID, object userState) {
        if ((this.GetCustomGroupOperationCompleted == null)) {
            this.GetCustomGroupOperationCompleted = new System.Threading.SendOrPostCallback(this.OnGetCustomGroupOperationCompleted);
        }
        this.InvokeAsync("GetCustomGroup", new object[] {
                    UserID}, this.GetCustomGroupOperationCompleted, userState);
    }
    
    private void OnGetCustomGroupOperationCompleted(object arg) {
        if ((this.GetCustomGroupCompleted != null)) {
            System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
            this.GetCustomGroupCompleted(this, new GetCustomGroupCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
        }
    }
    
    /// <remarks/>
    [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://electra-ai.com/GetOrderInterval", RequestNamespace="http://electra-ai.com/", ResponseNamespace="http://electra-ai.com/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
    public System.Data.DataSet GetOrderInterval(string UserID) {
        object[] results = this.Invoke("GetOrderInterval", new object[] {
                    UserID});
        return ((System.Data.DataSet)(results[0]));
    }
    
    /// <remarks/>
    public System.IAsyncResult BeginGetOrderInterval(string UserID, System.AsyncCallback callback, object asyncState) {
        return this.BeginInvoke("GetOrderInterval", new object[] {
                    UserID}, callback, asyncState);
    }
    
    /// <remarks/>
    public System.Data.DataSet EndGetOrderInterval(System.IAsyncResult asyncResult) {
        object[] results = this.EndInvoke(asyncResult);
        return ((System.Data.DataSet)(results[0]));
    }
    
    /// <remarks/>
    public void GetOrderIntervalAsync(string UserID) {
        this.GetOrderIntervalAsync(UserID, null);
    }
    
    /// <remarks/>
    public void GetOrderIntervalAsync(string UserID, object userState) {
        if ((this.GetOrderIntervalOperationCompleted == null)) {
            this.GetOrderIntervalOperationCompleted = new System.Threading.SendOrPostCallback(this.OnGetOrderIntervalOperationCompleted);
        }
        this.InvokeAsync("GetOrderInterval", new object[] {
                    UserID}, this.GetOrderIntervalOperationCompleted, userState);
    }
    
    private void OnGetOrderIntervalOperationCompleted(object arg) {
        if ((this.GetOrderIntervalCompleted != null)) {
            System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
            this.GetOrderIntervalCompleted(this, new GetOrderIntervalCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
        }
    }
...
/// <remarks/>
[System.CodeDom.Compiler.GeneratedCodeAttribute("wsdl", "2.0.50727.3038")]
public delegate void GetCustomGroupCompletedEventHandler(object sender, GetCustomGroupCompletedEventArgs e);

/// <remarks/>
[System.CodeDom.Compiler.GeneratedCodeAttribute("wsdl", "2.0.50727.3038")]
[System.Diagnostics.DebuggerStepThroughAttribute()]
[System.ComponentModel.DesignerCategoryAttribute("code")]
public partial class GetCustomGroupCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
    
    private object[] results;
    
    internal GetCustomGroupCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
            base(exception, cancelled, userState) {
        this.results = results;
    }
...
/// <remarks/>
[System.CodeDom.Compiler.GeneratedCodeAttribute("wsdl", "2.0.50727.3038")]
public delegate void GetOrderIntervalCompletedEventHandler(object sender, GetOrderIntervalCompletedEventArgs e);

/// <remarks/>
[System.CodeDom.Compiler.GeneratedCodeAttribute("wsdl", "2.0.50727.3038")]
[System.Diagnostics.DebuggerStepThroughAttribute()]
[System.ComponentModel.DesignerCategoryAttribute("code")]
public partial class GetOrderIntervalCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
    
    private object[] results;
    
    internal GetOrderIntervalCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
            base(exception, cancelled, userState) {
        this.results = results;
    }
